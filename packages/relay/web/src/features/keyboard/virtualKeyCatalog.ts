// Every key the touch toolbar can carry, and the ones it starts with.

import { ANSI_KEYS } from '@/shared/keys/keyEncoder';
...
export const DEFAULT_TOOLBAR_KEYS: ToolbarKeyDef[] = [
  ...
  { id: 'tab', label: 'TAB', code: ANSI_KEYS.TAB, type: 'key', enabled: true, title: 'Tab' },
  {
    ...
    enabled: true,
    modifierType: 'ctrl',
    title: 'Toggle Ctrl modifier latch',
  },
  {
    id: 'alt',
    label: 'ALT',
...
export const ALL_AVAILABLE_KEYS: ToolbarKeyDef[] = [
  ...
  },
  {
    ...
    enabled: true,
    modifierType: 'shift',
    title: 'Toggle Shift modifier latch',
  },
  {
    id: 'meta',
    label: 'META',
  ...
  },
  {
    ...
    type: 'chord',
    enabled: true,
    title: 'Ctrl+A (Beginning of Line)',
  },
  {
    id: 'ctrl_e',
    label: '^E',
