...
import { DEFAULT_TOOLBAR_KEYS, getLocalizedKeyTitle, type ToolbarKeyDef } from './virtualKeys';
import { AgentKeyActions } from './AgentKeyActions';
import { CAP_ACTIVE, CAP_BASE, CAP_COMMIT, CAP_IDLE, capSizes } from './caps';
