...
export const en: TranslationSchema = {
  ...
  admin: {
    ...
    subtitle: 'Host metrics, PTY sessions, and connected clients',
    returnToTerminal: 'Return to Terminal',
    terminalShells: 'Terminal Shells',
    startedAt: 'Started at {time}',
    sessionPanel: 'Session',
    sharedWindows: 'windows sharing this terminal',
    processRss: 'Process RSS',
    trendSamples: '{count} samples',
    perSecond: '{value}/s',
    ...
    colViewers: 'Windows',
    rawPayloadTitle: 'Raw status payload',
    copyJson: 'Copy JSON',
    copiedJson: 'Copied',
